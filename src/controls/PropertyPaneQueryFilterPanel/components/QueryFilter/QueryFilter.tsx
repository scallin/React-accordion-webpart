    ...
    private getOperatorDropdownOptions(): IDropdownOption[] {
        ...
        // Operators for Text, Number, Datetime and Lookup field types
            ...
            options = [
                ...
                { key: QueryFilterOperator[QueryFilterOperator.ne], text: this.props.strings.operatorNotEqualLabel },
                ...
                { key: QueryFilterOperator[QueryFilterOperator.ge], text: this.props.strings.operatorGreaterEqualLabel },
                { key: QueryFilterOperator[QueryFilterOperator.le], text: this.props.strings.operatorLessEqualLabel }
            ];
